...
- The lightweight execution layer (poll API, state machine, decision logic, and order placement) runs efficiently on a **MIcroserver gen8** via the [AI-Agent-Host](https://github.com/quantiota/AI-Agent-Host)
